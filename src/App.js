...
import jest from "./gallery/icons/jest.png";
import tailwind from "./gallery/icons/tailwind.png";
import gifMaker from "./gallery/screenshots/gifMaker.gif";
import footguess from "./gallery/screenshots/footguess.png";
import trivia from "./gallery/screenshots/trivia.png";
import tryunfo from "./gallery/screenshots/tryunfo.png";
import wallet from "./gallery/screenshots/wallet.png";
import solarSystem from "./gallery/screenshots/solarSystem.png";
import ticTacToe from "./gallery/screenshots/ticTacToe.png";
      ...
      <section className="page-section">
        ...
        <article className="about-section">
          ...
          <div className="about-text">
            ...
            <div>
              <img
                className="gif-image object-cover w-72 h-72"
                src={gifMaker}
                alt="Gif Igor"
              />
            </div>
        ...
        <section className="portfolio-section">
          <div className="block">
            <img
              ...
              src={footguess}
              alt="Screenshot of Footguess site"
            />
            <h5 className="mt-2 text-xl font-bold text-gray-900">Footguess</h5>
            <p className="max-w-sm text-gray-700 text-justify mx-0.5">
              Game developed in React that gives the user six chances to discover who the mystery soccer player of the day is.
              For that it gives clues based on previous guesses that came close to the answer.
            </p>
          ...
          <div className="block">
            <img
              className="object-cover w-full h-64"
              src={trivia}
              alt="Screenshot of Trivia site"
            />
            <h5 className="mt-2 text-xl font-bold text-gray-900">Trivia</h5>
            <p className="max-w-sm text-gray-700 text-justify mx-0.5">
              Game developed in React Redux in which the user has to answer five questions of any theme in less than 30 seconds.
              After that is presented a feedback message and ranking screen.
            </p>
            <div className="card-actions">
          ...
          <div className="block">
            <img
              ...
              src={wallet}
              alt="Screenshot of Wallet site"
            />
            <h5 className="mt-2 text-xl font-bold text-gray-900">Wallet</h5>
            <p className="max-w-sm text-gray-700 text-justify my-px">
              Website developed in React Redux where the user can control their budgets by inserting different expenses.
              Uses an API to get the exchange rate of various currencies.
            </p>
            <div className="card-actions">
          ...
          <div className="block">
            <img
              className="object-cover w-full h-64"
              src={tryunfo}
              alt="Screenshot of Tryunfo site"
            />
            <h5 className="mt-2 text-xl font-bold text-gray-900">Tryunfo</h5>
            <p className="max-w-sm text-gray-700 text-justify mx-0.5">
              Website developed in React that allows the user to create cards of NBA players, giving them points for different attributes and rarity.
              After is posible to filter the deck of cards by name or rarity.
            </p>
            <div className="card-actions">
          ...
          <div className="block">
            <img
              ...
              src={solarSystem}
              alt="Screenshot of Solar System site"
            />
            <h5 className="mt-2 text-xl font-bold text-gray-900">Solar System</h5>
            <p className="max-w-sm text-gray-700 text-justify my-px">
              Website developed in React that uses an API to show all the planets in our Solar System and every recorded mission to space.
            </p>
            <div className="card-actions">
          ...
          <div className="block">
            ...
            />
            <h5 className="mt-2 text-xl font-bold text-gray-900">Tic-Tac-Toe</h5>
            <p className="max-w-sm text-gray-700 text-justify mx-0.5">
              Game where you can play against a friend or the AI.
              Developed as the final project of CS50, a Harvard University course available on edX.
            </p>
            <div className="card-actions">
        ...
        <section className="contact-section">
          ...
          <div className="soc">
            <a href="https://www.facebook.com/castroigor" target="_blank" className="icon facebook" title="Facebook">
              <svg viewBox="0 0 512 512">
                <path d="M211.9 197.4h-36.7v59.9h36.7V433.1h70.5V256.5h49.2l5.2-59.1h-54.4c0 0 0-22.1 0-33.7 0-13.9 2.8-19.5 16.3-19.5 10.9 0 38.2 0 38.2 0V82.9c0 0-40.2 0-48.8 0 -52.5 0-76.1 23.1-76.1 67.3C211.9 188.8 211.9 197.4 211.9 197.4z"/>
              </svg>
            </a>
            <a href="https://github.com/IgorNCastro" target="_blank" className="icon github" title="GitHub">
            ...
            <a href="https://pt.stackoverflow.com/users/293325/igor-castro" target="_blank" className="icon stackoverflow" title="StackOverflow">
              <svg viewBox="0 0 512 512">
            ...
            <a href="https://www.linkedin.com/in/igorncastro/" target="_blank" className="icon linkedin" title="LinkedIn">
              <svg viewBox="0 0 512 512">
